...
CompSciQuestionList = [{"moneyvalue": "100", "question": "JavaScript requires all commands to end with this character", "answer": ";"},
{"moneyvalue": "200", "question": "The creator of Python, Guido van Rossum, is Dutch. The capital of his home country is this city.", "answer": "Amsterdam"},
{"moneyvalue": "300", "question": "When a phrase is encased in quotation marks (""), it is known as this.", "answer": "string"},
{"moneyvalue": "400", "question": "What is the system used to fetch web pages based on a URL (ex: google.com)?", "answer": "Domain Name System (DNS)"},
{"moneyvalue": "500", "question": "How would you write an HTML comment with the content “Stores variables” (without quotes)?", "answer": "<!-- Stores variables -->"},
{"moneyvalue": "600", "question": "Sharing a name with a fairy-like creature in European folklore, a collection of images put into a single image in JavaScript.", "answer": "Sprite"},
{"moneyvalue": "700", "question": "C++ was created by this Danish computer scientist in 1983.", "answer": "Bjarne Stroustrup"}]
...
[{"moneyvalue": "400", "question": "The notoriously difficult final boss of this game, along with its soundtrack, has skyrocketed this game’s popularity. Name the 2015 indie game where a child falls into the land of monsters.", "answer": "Undertale"}
...
[{"moneyvalue": "700", "question": "This animal’s scientific name is the same word twice.", "answer": "Skunk"}
